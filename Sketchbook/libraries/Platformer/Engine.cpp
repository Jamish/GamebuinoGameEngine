...
const byte world[] PROGMEM =
{
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 
    ...
    , 
...
void Engine::begin() {
	...
	addActor(new Player(18, 36));
    addActor(new Enemy(138, 36));
    addActor(new Enemy(182, 36));
    addActor(new Enemy(204, 36));
}
        ...
        for (y = 0; y < h; y++) {
            for (x = 0; x < w; x++) {
                ...
                if (tileNumber == BG_BLOCK) {
                    if (tileAtPosition(x * SPRITE_SIZE, y * SPRITE_SIZE - 1) != BG_BLOCK) {
                        uint8_t adjacent = 2;
